...
# PREVENTATIVE CAUSES
prev_objects_stim = as.data.frame(matrix(NA, nrow=100, ncol=20))
...
# GENERATIVE CAUSES
gen_objects_stim = as.data.frame(matrix(NA, nrow=nrow(objects_full), ncol=20))
for(i in 1:nrow(objects_full)){
...
# AMBIGUOUS CAUSES 1
ambig_objects_stim_1 = as.data.frame(matrix(NA, nrow=nrow(objects_full), ncol=20))
for(i in 1:nrow(objects_full)){
...
# AMBIGUOUS CAUSES 2
ambig_objects_stim_2 = as.data.frame(matrix(NA, nrow=nrow(objects_full), ncol=20))
for(i in 1:nrow(objects_full)){
  if(objects_full[i,1]==1|objects_full[i,2]==1|objects_full[i,3]==1|objects_full[i,4]==1|objects_full[i,5]==1|objects_full[i,6]==1|objects_full[i,7]==1|objects_full[i,8]==1|objects_full[i,9]==1|objects_full[i,10]==1|objects_full[i,11]==1|objects_full[i,12]==1|objects_full[i,13]==1|objects_full[i,14]==1){
